...
- Uma implementação eficiente da pilha pode ser efetuada sobre uma lista sequencial, por exemplo, a atividade [@vetbuild](../../.tko/cache/ed/base/pilha/../vetbuild/README.md).
